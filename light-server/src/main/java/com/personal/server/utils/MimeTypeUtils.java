...
import com.personal.server.LightServer;
import com.personal.server.model.MimeType;
...
public class MimeTypeUtils {
	...
	static {
		Yaml yaml = new Yaml();
		Object obj = yaml.load(LightServer.class.getResourceAsStream("/mimeMapping.yml"));
